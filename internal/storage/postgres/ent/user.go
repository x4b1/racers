...
func (e UserEdges) RacesOrErr() ([]*Race, error) {
	if e.loadedTypes[0] {
		return e.Races, nil
	}
...
// QueryRaces queries the races edge of the User.
func (u *User) QueryRaces() *RaceQuery {
	return (&UserClient{config: u.config}).QueryRaces(u)
}
